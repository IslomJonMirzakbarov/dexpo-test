      ...
      <Box className={styles.Container}>
                     ...
                     <Box className={styles.DropZone}>
                        ...
                        <Box className={styles.TermsAgreement}>
                           ...
                           <Box className={styles.AgreementTxt}>
                              I declare that this is an original artwork. I
                              understand that no plagiarism is allowed, and that
         ...
         <Box className={styles.BottomSide}>
            ...
            <Box className={styles.MintTxt}>
               ...
               addition, the content will be uploaded <br /> after censoring it.
               If the content is incorrect, the upload may berejected.
            </Box>
         </Box>
