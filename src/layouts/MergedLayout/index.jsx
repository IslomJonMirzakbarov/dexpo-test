    ...
    return <>
        <Header 
            ...
            extra={
                ...
                >
                    ...
                    <PersonIcon 
                        className={classNames(styles.profile,{ [styles.active]: isProfileOpen })}
        ...
        >
            <List className={styles.navList}>
                {
                    pages.map(page => 
                        <ListItem className={classNames(styles.navItem, { [styles.active]: pathname.includes(page.to) })} key={page.name}>
                            <NavLink to={page.to}>
